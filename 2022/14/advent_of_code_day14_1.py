...
while not all_resting:
    if (sand_x + 1 > max_x and sand_y + 1 > max_y) or (sand_x - 1 < min_x and sand_y + 1 > max_y):
        all_resting = True
    elif not (sand_x, sand_y+1) in rock_coordinates:
        sand_y += 1
    elif not (sand_x-1, sand_y+1) in rock_coordinates:
        sand_x -= 1
        sand_y += 1
    elif not (sand_x+1, sand_y+1) in rock_coordinates:
        sand_x += 1
